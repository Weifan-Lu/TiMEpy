...
def pre1_select_catalog_fault(config):
    ...
    # ----- 4. Second Step Filtering: Perform Filtering on the Half-Size Rectangular Area -----
    ...
    # Construct the Simplified Catalog Data: [year, month, lat, lon, depth, mag]
    ...
    # Draw a rectangle representing the filtered region
